...
# (by Stefan.Manegold@cwi.nl, http://www.cwi.nl/~manegold/)
 ...
 set output 'result.txt.cache-miss-latency.ps'
...
#set output 'result.txt.cache-miss-latency.gif'
set data style linespoints
set key below
set title 'result.txt.cache-miss-latency'
...
'result.txt.cache-miss-latency.data' using 1:($7-199.570000) title '16' with linespoints lt 1 pt 3 , \
'result.txt.cache-miss-latency.data' using 1:($13-199.570000) title '8' with linespoints lt 2 pt 4
set nolabel
set noarrow
