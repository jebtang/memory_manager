...
\paragraph{}
The paper is organized as follows: Section \ref{sec:design} describes the design of Tracer. Section \ref{sec:evaluation} describes the microbenchmark study and discussion of results. Section \ref{sec:motivation} outlines the motivation underlying our work. Section \ref{sec:relatedwork} discusses some of the works related to Tracer's design. Section \ref{sec:futurework} provides insight into useful ideas which could improve the design of Tracer. Section \ref{sec:conclusion} provides a summary of our work.
